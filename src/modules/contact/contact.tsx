    ...
    <section className="text-white relative">
      <Container>
        <div className="text-center mb-14 flex flex-col gap-12 items-center justify-center text-white">
          ...
          <div className="w-60 h-60 overflow-hidden rounded-full">{props.image && <Image loader={imageLoader} {...props.image} width={200} className="w-full h-full object-cover" />}</div>
